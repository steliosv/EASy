/** @file RS-FEC.h
    ...
    This contains the library for Reed-Solomon encoder/decoding methods

    @author Simon Peter https://github.com/simonyipeter/Reed-Solomon
    @bug No known bugs.
*/
#ifndef POLY_H
#define POLY_H
...
struct Poly {
    ...
    /* @brief Polynomial copy
     * @param src - Polynomial*/
